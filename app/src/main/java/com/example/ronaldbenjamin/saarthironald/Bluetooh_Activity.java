...
public class Bluetooh_Activity extends AppCompatActivity {
    ...
    private final String TAG = Bluetooh_Activity.class.getSimpleName();
    private Handler mHandler; // Our main handler that will receive callback notifications
    private ConnectedThread
            mConnectedThread; // bluetooth background worker thread to send and receive data
    ...
    private static final int CONNECTING_STATUS =
            3; // used in bluetooth handler to identify message status

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bluetooh_);
        ...
        if (mBTArrayAdapter == null) {
            ...
            Toast.makeText(getApplicationContext(), "Bluetooth device not found!", Toast.LENGTH_SHORT)
                    .show();
        } else {
    ...
    final BroadcastReceiver blReceiver =
    ...
    private BluetoothSocket createBluetoothSocket(BluetoothDevice device) throws IOException {
        try {
            final Method m =
                    device.getClass().getMethod("createInsecureRfcommSocketToServiceRecord", UUID.class);
            ...
            while (true) {
                try {
                    ...
                    if (bytes != 0) {
                        ...
                        SystemClock.sleep(
                                100); // pause and wait for rest of data. Adjust this depending on your sending
                        // speed.
    ...
    public void BluetoothConnection()
    {
        ...
        BluetoothDevice device = mBluetoothAdapter.getRemoteDevice("B8:D5:0B:03:33:11");
